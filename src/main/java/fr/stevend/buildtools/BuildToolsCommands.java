    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            ArrayList<String> cut_lore = new ArrayList<String>() {{
                add("This will cut your last world edit selection");
            }};
            ...
            ArrayList<String> copy_lore = new ArrayList<String>() {{
                add("This will copy your last world edit selection");
            }};
            ...
            ArrayList<String> paste_lore = new ArrayList<String>() {{
                add("This will paste your last clipboard item");
            }};
            paste_meta.setLore(paste_lore);
            paste.setItemMeta(paste_meta);

            ItemStack undo = new ItemStack(Material.COBWEB, 1);
            ...
            ArrayList<String> undo_lore = new ArrayList<String>() {{
                add("This will Undo your last world edit action");
            }};
            undo_meta.setLore(undo_lore);
            undo.setItemMeta(undo_meta);

            inventory.setItem(1, cut);
            inventory.setItem(3, copy);
            inventory.setItem(5, paste);
            inventory.setItem(7, undo);
